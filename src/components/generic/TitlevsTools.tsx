...
const TitlevsTools = ({
  ...
  return (
    <section className="grid gap-8 border-t border-border/70 pt-8 lg:grid-cols-[0.42fr_1.58fr] lg:gap-14" data-robot-guide={robotGuide}>
      <Reveal>
        <div className="lg:sticky lg:top-28"><span className="block h-px w-10 bg-indigo-500" /><h2 className="mt-5 text-2xl font-semibold tracking-tight sm:text-3xl">{title}</h2></div>
      </Reveal>
